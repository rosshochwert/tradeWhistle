class PlayersController < ApplicationController
  ...
  def download
    @urlLeagueKey = "http://fantasysports.yahooapis.com/fantasy/v2/league/" + $league_key + "/players/percent_owned?format=json"
    ...
    @playersStatHash.each do |key,value|
      ...
      percent = value["player"][0][1]["percent_owned"][1]
      percent = value["player"][0][1]["percent_owned"][1]["value"]
